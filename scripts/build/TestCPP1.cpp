...
static PyObject* exec_TestCPP1(PyObject*self, PyObject* args, PyObject* kywds)
{
    ...
    if(!PyArg_ParseTupleAndKeywords(args,kywds,"O|O:exec_TestCPP1",const_cast<char**>(kwlist),&py_image, &py_local_dict))
       return NULL;
    try                              
    {                                
        py_image = py_image;
...
static PyObject* help_TestCPP1(PyObject*self, PyObject* args, PyObject* kywds)
{
    py::object return_val;
    int exception_occurred = 0;
    PyObject *py_local_dict = NULL;
    static const char *kwlist[] = {"local_dict", NULL};
    if(!PyArg_ParseTupleAndKeywords(args,kywds,"|O:help_TestCPP1",const_cast<char**>(kwlist),&py_local_dict))
       return NULL;
    try                              
    {                                
        /*<function call here>*/     
...
static PyObject* init_TestCPP1(PyObject*self, PyObject* args, PyObject* kywds)
{
    py::object return_val;
    int exception_occurred = 0;
    PyObject *py_local_dict = NULL;
    ...
    if(!PyArg_ParseTupleAndKeywords(args,kywds,"OO|O:init_TestCPP1",const_cast<char**>(kwlist),&py_p, &py_pip, &py_local_dict))
       return NULL;
    try                              
    {                                
        py_p = py_p;
...
static PyObject* config_TestCPP1(PyObject*self, PyObject* args, PyObject* kywds)
{
    py::object return_val;
    int exception_occurred = 0;
    PyObject *py_local_dict = NULL;
    static const char *kwlist[] = {"local_dict", NULL};
    if(!PyArg_ParseTupleAndKeywords(args,kywds,"|O:config_TestCPP1",const_cast<char**>(kwlist),&py_local_dict))
       return NULL;
    try                              
    {                                
        /*<function call here>*/     
...
{
    {"exec_TestCPP1",(PyCFunction)exec_TestCPP1 , METH_VARARGS|METH_KEYWORDS},
    {"help_TestCPP1",(PyCFunction)help_TestCPP1 , METH_VARARGS|METH_KEYWORDS},
    {"init_TestCPP1",(PyCFunction)init_TestCPP1 , METH_VARARGS|METH_KEYWORDS},
    {"config_TestCPP1",(PyCFunction)config_TestCPP1 , METH_VARARGS|METH_KEYWORDS},
    {NULL,      NULL}        /* Sentinel */
};

PyMODINIT_FUNC initTestCPP1(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("TestCPP1", compiled_methods);
}
